...
public final class ServerConfig {
    public static final String CA_HOST = "100.106.104.1"; // đổi thành IP máy server khi chạy 2 máy LAN
    public static final String AS_HOST = "100.106.104.1";
    public static final String TGS_HOST = "100.106.104.1";
    public static final String CHAT_HOST = "100.106.104.1";
