...
### 7.1 Điểm mạnh
1. **Kiến trúc Không tin cậy máy chủ:** Khác với các ứng dụng nhắn tin truyền thống, kiến trúc mã hóa đầu cuối đảm bảo máy chủ Chat chỉ đóng vai trò "Trạm trung chuyển". Server hoàn toàn "mù" trước nội dung dữ liệu.
...
* **Ngôn ngữ Lập trình:** Java 17 LTS (Đảm bảo hiệu suất và bảo mật dài hạn).
...
| **Tốt** | **Tách rõ master key và session key.** | [x] | Phân biệt rạch ròi: **Master Key** (RSA bất đối xứng) định danh dài hạn. **Session Key** (AES ngẫu nhiên) chỉ tồn trên RAM. Kiểm soát ranh giới khóa bằng **Key Usage (RFC 5280)** trên chứng chỉ X.509 v3 và **Control Vector** trong vé Kerberos, ngăn Key Confusion Attack. |
